...
using MyProjectName.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(MyProjectNameWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(MyProjectNameNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(MyProjectNameNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(MyProjectNameNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(MyProjectNameNames.WebAppApi);
        });
    }
